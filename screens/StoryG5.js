...
export default class StoryG5 extends Component{
render(){
return(
<View style = {{flex:1}}>

<Header backgroundColor = {'teal'} centerComponent = {{text: 'Grade 5 Stories', style :{color:'white', fontSize:15, fontFamily: 'Papyrus'}}}/>



<Text style = {styles.textBox}> Collateral Conservation </Text>
...
color:"black",
width:300,
fontFamily:'Papyrus', marginBottom:200, marginLeft:30}}  onPress={ ()=> Linking.openURL('https://www.nationalgeographic.org/video/jaguar-vs-croc/')}>https://www.nationalgeographic.org/video/jaguar-vs-croc/
</Text>
